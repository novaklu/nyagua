 ...
 */
public class InvBase {
    public static final String TABLE = "InvBase";
    public static final String [] CAPTIONS = {
        java.util.ResourceBundle.getBundle("nyagua/Bundle").getString("ID"),
                 ...
                 java.util.ResourceBundle.getBundle("nyagua/Bundle").getString("TDS_MIN"),
                 java.util.ResourceBundle.getBundle("nyagua/Bundle").getString("TDS_MAX")
    ...
    public String getTdsMin() {
        return tdsMin;
    }

    public void setTdsMin(String tdsMin) {
        this.tdsMin = tdsMin;
    }

    public String getTdsMax() {
        return tdsMax;
    }

    public void setTdsMax(String tdsMax) {
        this.tdsMax = tdsMax;
    }
    ...
    public static void setFilter(String filter){
        InvBase.filter=filter;
    }
    // </editor-fold>

    /**
     * get InvBase from Db by id
     *
     * @param recId
     * @return InvBase
     */
    public static InvBase getById (int recId){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                specData.tdsMin = LocUtil.localizeDouble(rs.getString("TDSmin")); // NOI18N
                specData.tdsMax = LocUtil.localizeDouble(rs.getString("TDSmax")); // NOI18N
     ...
     * @return InvBase
     */
    public static InvBase getByName (String name){
        InvBase specData = new InvBase();
     ...
     * Save InvBase to db
     *
     * @param specData InvBase to save
     */
    public static void save(InvBase specData){
        ...
        try {
            ...
            prep.setString(21,specData.tdsMin);
            prep.setString(22,specData.tdsMax); 
            prep.executeUpdate();            
        } catch (SQLException ex) {
            _log.log(Level.SEVERE, null, ex);
        }        
    ...
    public static void deleteById (String recId, String Name){
        ...
        try {//check for related records
            records=DB.DBCountRelated(Name, "Inverts", "Name");//NOI18N            
        } catch (SQLException ex) {
            _log.log(Level.SEVERE, null, ex);
        }
        if (records == 0){
            ...
            msg=msg+java.util.ResourceBundle.getBundle("nyagua/Bundle").getString("CANT_DELETE_RELATED")+ " " + java.util.ResourceBundle.getBundle("nyagua/Bundle").getString("INVERTS_");//NOI18N
    ...
    public static void populateTable (JTable displayData){
        try {
            if (displayData.getColumnCount()>1){ //save col width
                InvBase.setColWidth(Util.getColSizes(displayData));
            }
            ...
            while (rs.next()) {
                ...
                tableData[x][20] = LocUtil.localizeDouble(rs.getString("TDSmin")); // NOI18N
                tableData[x][21] = LocUtil.localizeDouble(rs.getString("TDSmax")); // NOI18N
    ...
    public static void populateCombo (JComboBox DisplayCombo){
        ...
        ResultSet rs;
            ...
            if (totElements == 0) {
                dcm.addElement(java.util.ResourceBundle.getBundle("nyagua/Bundle").getString("invtable_combobox_default"));
            } else {
    ...
    static final Logger _log = Logger.getLogger(InvBase.class.getName());
