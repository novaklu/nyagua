 ...
 */
public class Fish {
    public static final String TABLE = "Fishes";
     ...
     * @return Fish
     */
    public static Fish getById (int recId){
        Fish specimen = new Fish();
    ...
    public static void populateTable (JTable diplayData){
        try {
            if (diplayData.getColumnCount()>1){ //save col width
                Fish.setColWidth(Util.getColSizes(diplayData));
            }
    ...
    static final Logger _log = Logger.getLogger(Fish.class.getName());
